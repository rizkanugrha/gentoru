...
const schema = async (m, sock, db) => {
  ...
  if (setting) {
    ...
    if (!('ch_id' in setting)) setting.ch_id = '';
    if (!('ch_name' in setting)) setting.ch_name = '';
    if (!('logo' in setting)) setting.logo = '';
    if (!('dev' in setting)) setting.dev = '';
    if (!('packname' in setting)) setting.packname = '';
    ...
    if (!('price' in setting)) setting.price = {
      mem: "0%",
      res: "0%",
      part: "0%"
    };
